...
class bbp_5o1_ignore_user {
	...
	static public function set_ignored_users($user_id, $ignored_users) {
	...
	static public function hide_ignored_topics($have_posts, $topic_query) {
		$bbp = bbpress();
		$a = new MyClass();
	...
	static public function hide_ignored_replies($have_posts, $reply_query) {
		$bbp = bbpress();
		$ignored_users = bbp_5o1_ignore_user::get_ignored_users();
		if ( empty($ignored_users) ) // Nothing to do.
			return $have_posts;
	...
	static public function show_users_ignore_list() {
	...
	static public function show_ignore_user_button($author_link) {
		$user_id = bbp_get_current_user_id();
	...
	static public function ajax_unignore_user() {
	...
	static public function ajax_ignore_user() {
